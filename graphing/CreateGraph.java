...
public class CreateGraph {
    public static void setData(ArrayList<ArrayList<String>> chartData, int xAxisIndex, int yAxisIndex) {
        ...
        JFreeChart generatedChart = generateChart(dataset);
        //This file is only for testing the graph program for now

        //Should eventually output jpeg for UI class to use
        saveChart(generatedChart);
    }
